...
const IncludeMapEntry libc_symbol_map[] = {
  ...
  { "std::string", kPrivate, "<iosfwd>", kPublic },
  ...
  // From Darwin headers: /usr/include/_types
  { "intmax_t", kPrivate, "<stdint.h>", kPublic },
  { "nl_item", kPrivate, "<langinfo.h>", kPublic },
  { "nl_item", kPrivate, "<nl_types.h>", kPublic },
  { "nl_item", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_langinfo.h
  { "uint8_t", kPrivate, "<stdint.h>", kPublic },
  { "uint16_t", kPrivate, "<stdint.h>", kPublic },
  { "uint32_t", kPrivate, "<stdint.h>", kPublic },
  { "uint32_t", kPrivate, "<stdlib.h>", kPublic },
  { "uint32_t", kPrivate, "<sys/unistd.h>", kPublic },
  { "uint32_t", kPrivate, "<sys/snapshot.h>", kPublic },
  { "uint32_t", kPrivate, "<sys/netport.h>", kPublic },
  { "uint32_t", kPrivate, "<sys/clonefile.h>", kPublic },
  { "uint64_t", kPrivate, "<stdint.h>", kPublic },
  { "uint64_t", kPrivate, "<sys/unistd.h>", kPublic },
  { "uint64_t", kPrivate, "<sys/fsgetpath.h>", kPublic },
  { "uintmax_t", kPrivate, "<stdint.h>", kPublic },
  { "wctrans_t", kPrivate, "<wctype.h>", kPublic },
  { "wctrans_t", kPrivate, "<wchar.h>", kPublic },
  { "wctrans_t", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_wctype.h
  { "wctype_t", kPrivate, "<wctype.h>", kPublic },
  { "wctype_t", kPrivate, "<wchar.h>", kPublic },
  { "wctype_t", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_wctype.h
  // From Darwin headers: /usr/include/sys/_types
  { "blkcnt_t", kPrivate, "<sys/stat.h>", kPublic },
  { "blkcnt_t", kPrivate, "<sys/types.h>", kPublic },
  { "blksize_t", kPrivate, "<sys/stat.h>", kPublic },
  { "blksize_t", kPrivate, "<sys/types.h>", kPublic },
  { "caddr_t", kPrivate, "<sys/types.h>", kPublic },
  { "caddr_t", kPrivate, "<sys/pipe.h>", kPublic },
  { "caddr_t", kPrivate, "<sys/vm.h>", kPublic },
  { "clock_t", kPrivate, "<time.h>", kPublic },
  { "clock_t", kPrivate, "<sys/time.h>", kPublic },
  { "clock_t", kPrivate, "<sys/types.h>", kPublic },
  { "ct_rune_t", kPrivate, "<runetype.h>", kPublic },
  { "ct_rune_t", kPrivate, "<wchar.h>", kPublic },
  { "ct_rune_t", kPrivate, "<stdlib.h>", kPublic },
  { "dev_t", kPrivate, "<fts.h>", kPublic },
  { "dev_t", kPrivate, "<unistd.h>", kPublic },
  { "dev_t", kPrivate, "<stdlib.h>", kPublic },
  { "dev_t", kPrivate, "<sys/stat.h>", kPublic },
  { "dev_t", kPrivate, "<sys/types.h>", kPublic },
  { "errno_t", kPrivate, "<string.h>", kPublic },
  { "errno_t", kPrivate, "<sys/errno.h>", kPublic },
  { "errno_t", kPrivate, "<sys/types.h>", kPublic },
  { "FD_CLR", kPrivate, "<sys/select.h>", kPublic },
  { "FD_CLR", kPrivate, "<sys/time.h>", kPublic },
  { "FD_CLR", kPrivate, "<sys/types.h>", kPublic },
  { "FD_COPY", kPrivate, "<sys/select.h>", kPublic },
  { "FD_COPY", kPrivate, "<sys/time.h>", kPublic },
  { "FD_COPY", kPrivate, "<sys/types.h>", kPublic },
  { "FD_ISSET", kPrivate, "<sys/select.h>", kPublic },
  { "FD_ISSET", kPrivate, "<sys/time.h>", kPublic },
  { "FD_ISSET", kPrivate, "<sys/types.h>", kPublic },
  { "FD_SET", kPrivate, "<sys/select.h>", kPublic },
  { "FD_SET", kPrivate, "<sys/time.h>", kPublic },
  { "FD_SET", kPrivate, "<sys/types.h>", kPublic },
  { "FD_SETSIZE", kPrivate, "<sys/select.h>", kPublic },
  { "FD_SETSIZE", kPrivate, "<sys/time.h>", kPublic },
  { "FD_SETSIZE", kPrivate, "<sys/types.h>", kPublic },
  { "FD_ZERO", kPrivate, "<sys/select.h>", kPublic },
  { "FD_ZERO", kPrivate, "<sys/time.h>", kPublic },
  { "FD_ZERO", kPrivate, "<sys/types.h>", kPublic },
  { "filesec_t", kPrivate, "<sys/fcntl.h>", kPublic },
  { "filesec_t", kPrivate, "<sys/stat.h>", kPublic },
  { "fsblkcnt_t", kPrivate, "<sys/statvfs.h>", kPublic },
  { "fsblkcnt_t", kPrivate, "<sys/types.h>", kPublic },
  { "fsfilcnt_t", kPrivate, "<sys/statvfs.h>", kPublic },
  { "fsfilcnt_t", kPrivate, "<sys/types.h>", kPublic },
  { "fsid_t", kPrivate, "<sys/fsgetpath.h>", kPublic },
  { "fsid_t", kPrivate, "<sys/mount.h>", kPublic },
  { "fsobj_id_t", kPrivate, "<sys/attr.h>", kPublic },
  { "gid_t", kPrivate, "<grp.h>", kPublic },
  { "gid_t", kPrivate, "<pwd.h>", kPublic },
  { "gid_t", kPrivate, "<unistd.h>", kPublic },
  { "gid_t", kPrivate, "<sys/ipc.h>", kPublic },
  { "gid_t", kPrivate, "<sys/socket.h>", kPublic },
  { "gid_t", kPrivate, "<sys/stat.h>", kPublic },
  { "gid_t", kPrivate, "<sys/unistd.h>", kPublic },
  { "gid_t", kPrivate, "<sys/types.h>", kPublic },
  { "guid_t", kPrivate, "<sys/kauth.h>", kPublic },
  { "guid_t", kPrivate, "<sys/kernel_types.h>", kPublic },
  { "id_t", kPrivate, "<sys/resource.h>", kPublic },
  { "id_t", kPrivate, "<sys/wait.h>", kPublic },
  { "id_t", kPrivate, "<sys/types.h>", kPublic },
  { "in_addr_t", kPrivate, "<sys/types.h>", kPublic },
  { "in_port_t", kPrivate, "<sys/types.h>", kPublic },
  { "ino_t", kPrivate, "<fts.h>", kPublic },
  { "ino_t", kPrivate, "<sys/dirent.h>", kPublic },
  { "ino_t", kPrivate, "<sys/stat.h>", kPublic },
  { "ino_t", kPrivate, "<sys/types.h>", kPublic },
  { "ino64_t", kPrivate, "<sys/stat.h>", kPublic },
  { "ino64_t", kPrivate, "<sys/types.h>", kPublic },
  { "int8_t", kPrivate, "<stdint.h>", kPublic },
  { "int8_t", kPrivate, "<i386/types.h>", kPublic },
  { "int16_t", kPrivate, "<stdint.h>", kPublic },
  { "int16_t", kPrivate, "<i386/types.h>", kPublic },
  { "int32_t", kPrivate, "<stdint.h>", kPublic },
  { "int32_t", kPrivate, "<sys/vm.h>", kPublic },
  { "int32_t", kPrivate, "<i386/types.h>", kPublic },
  { "int64_t", kPrivate, "<stdint.h>", kPublic },
  { "int64_t", kPrivate, "<i386/types.h>", kPublic },
  { "intptr_t", kPrivate, "<stdint.h>", kPublic },
  { "intptr_t", kPrivate, "<unitstd.h>", kPublic },
  { "key_t", kPrivate, "<sys/ipc.h>", kPublic },
  { "key_t", kPrivate, "<sys/types.h>", kPublic },
  { "mbstate_t", kPrivate, "<wchar.h>", kPublic },
  { "mode_t", kPrivate, "<ndbm.h>", kPublic },
  { "mode_t", kPrivate, "<spawn.h>", kPublic },
  { "mode_t", kPrivate, "<stdlib.h>", kPublic },
  { "mode_t", kPrivate, "<unistd.h>", kPublic },
  { "mode_t", kPrivate, "<sys/ipc.h>", kPublic },
  { "mode_t", kPrivate, "<sys/fcntl.h>", kPublic },
  { "mode_t", kPrivate, "<sys/mman.h>", kPublic },
  { "mode_t", kPrivate, "<sys/stat.h>", kPublic },
  { "mode_t", kPrivate, "<sys/types.h>", kPublic },
  ...
  { "nlink_t", kPrivate, "<sys/stat.h>", kPublic },
  { "nlink_t", kPrivate, "<sys/types.h>", kPublic },
  { "O_DSYNC", kPrivate, "<sys/aio.h>", kPublic },
  { "O_DSYNC", kPrivate, "<sys/fcntl.h>", kPublic },
  { "O_SYNC", kPrivate, "<sys/aio.h>", kPublic },
  { "O_SYNC", kPrivate, "<sys/fcntl.h>", kPublic },
  { "off_t", kPrivate, "<stdio.h>", kPublic },
  { "off_t", kPrivate, "<unistd.h>", kPublic },
  { "off_t", kPrivate, "<sys/aio.h>", kPublic },
  { "off_t", kPrivate, "<sys/fcntl.h>", kPublic },
  { "off_t", kPrivate, "<sys/mman.h>", kPublic },
  { "off_t", kPrivate, "<sys/socket.h>", kPublic },
  { "off_t", kPrivate, "<sys/stat.h>", kPublic },
  { "off_t", kPrivate, "<sys/types.h>", kPublic },
  ...
  { "pid_t", kPrivate, "<utmpx.h>", kPublic },
  { "pid_t", kPrivate, "<termios.h>", kPublic },
  { "pid_t", kPrivate, "<sys/fcntl.h>", kPublic },
  { "pid_t", kPrivate, "<sys/lctx.h>", kPublic },
  { "pid_t", kPrivate, "<sys/msg.h>", kPublic },
  { "pid_t", kPrivate, "<sys/sem.h>", kPublic },
  { "pid_t", kPrivate, "<sys/shm.h>", kPublic },
  { "pid_t", kPrivate, "<sys/signal.h>", kPublic },
  { "pid_t", kPrivate, "<sys/socket.h>", kPublic },
  { "pid_t", kPrivate, "<sys/wait.h>", kPublic },
  { "pid_t", kPrivate, "<sys/types.h>", kPublic },
  { "_POSIX_VDISABLE", kPrivate, "<sys/termios.h>", kPublic },
  { "_POSIX_VDISABLE", kPrivate, "<sys/unistd.h>", kPublic },
  { "ptrdiff_t", kPrivate, "<stddef.h>", kPublic },
  { "rsize_t", kPrivate, "<stddef.h>", kPublic },
  { "rsize_t", kPrivate, "<string.h>", kPublic },
  { "rsize_t", kPrivate, "<sys/types.h>", kPublic },
  { "rune_t", kPrivate, "<runetype.h>", kPublic },
  { "rune_t", kPrivate, "<wchar.h>", kPublic },
  { "rune_t", kPrivate, "<stdlib.h>", kPublic },
  { "sa_family_t", kPrivate, "<sys/socket.h>", kPublic },
  { "sa_family_t", kPrivate, "<sys/un.h>", kPublic },
  { "sigset_t", kPrivate, "<spawn.h>", kPublic },
  { "sigset_t", kPrivate, "<sys/select.h>", kPublic },
  { "sigset_t", kPrivate, "<sys/signal.h>", kPublic },
  { "sigset_t", kPrivate, "<sys/uocontext.h>", kPublic },
  ...
  { "time_t", kPrivate, "<utmp.h>", kPublic },
  ...
  { "time_t", kPrivate, "<sys/timeb.h>", kPublic },
  { "time_t", kPrivate, "<sys/types.h>", kPublic },
  { "timeval64", kPrivate, "<sys/time.h>", kPublic },
  { "u_char", kPrivate, "<sys/kern_control.h>", kPublic },
  { "u_char", kPrivate, "<sys/types.h>", kPublic },
  { "u_int", kPrivate, "<sys/pipe.h>", kPublic },
  { "u_int", kPrivate, "<sys/types.h>", kPublic },
  { "u_int8_t", kPrivate, "<i386/types.h>", kPublic },
  { "u_int16_t", kPrivate, "<i386/types.h>", kPublic },
  { "u_int16_t", kPrivate, "<sys/acct.h>", kPublic },
  { "u_int16_t", kPrivate, "<sys/kern_control.h>", kPublic },
  { "u_int32_t", kPrivate, "<i386/types.h>", kPublic },
  { "u_int32_t", kPrivate, "<sys/acct.h>", kPublic },
  { "u_int32_t", kPrivate, "<sys/kern_control.h>", kPublic },
  { "u_int32_t", kPrivate, "<sys/mbuf.h>", kPublic },
  { "u_int64_t", kPrivate, "<i386/types.h>", kPublic },
  { "u_int64_t", kPrivate, "<sys/mbuf.h>", kPublic },
  { "u_short", kPrivate, "<sys/mbuf.h>", kPublic },
  { "u_short", kPrivate, "<sys/types.h>", kPublic },
  { "ssize_t", kPrivate, "<string.h>", kPublic },
  { "uid_t", kPrivate, "<utmpx.h>", kPublic },
  { "uintptr_t", kPrivate, "<stdint.h>", kPublic },
  { "wchar_t", kPrivate, "<stddef.h>", kPublic },
  { "wchar_t", kPrivate, "<unistd.h>", kPublic },
  { "wchar_t", kPrivate, "<stdlib.h>", kPublic },
  { "wchar_t", kPrivate, "<runetype.h>", kPublic },
  { "wchar_t", kPrivate, "<wchar.h>", kPublic },
  { "wchar_t", kPrivate, "<inttypes.h>", kPublic },
  { "wchar_t", kPrivate, "<iconv.h>", kPublic },
...
const IncludeMapEntry libstdcpp_include_map[] = {
  ...
  // Mappings for libcxx.llvm.org, drawn from
  // https://github.com/google/libcxx/tree/master/include
  { "<__bit_reference>", kPrivate, "<vector>", kPublic }, // std::vector<bool>
  { "<__bit_reference>", kPrivate, "<bitset>", kPublic },
  { "<__bit_reference>", kPrivate, "<vector>", kPublic },
  { "<__functional_03>", kPrivate, "<functional>", kPublic },
  { "<__functional_base>", kPrivate, "<functional>", kPublic },
  { "<__functional_base>", kPrivate, "<typeindex>", kPublic },
  { "<__functional_base>", kPrivate, "<thread>", kPublic },
  { "<__functional_base>", kPrivate, "<system_error>", kPublic },
  { "<__functional_base>", kPrivate, "<bitset>", kPublic },
  { "<__functional_base>", kPrivate, "<tuple>", kPublic },
  { "<__functional_base>", kPrivate, "<vector>", kPublic },
  { "<__functional_base>", kPrivate, "<memory>", kPublic },
  { "<__functional_base>", kPrivate, "<string>", kPublic },
  { "<__hash_table>", kPrivate, "<map>", kPublic },
  { "<__hash_table>", kPrivate, "<unordered_set>", kPublic },
  { "<__hash_table>", kPrivate, "<unordered_map>", kPublic },
  { "<__hash_table>", kPrivate, "<ext/hash_set>", kPublic },
  { "<__hash_table>", kPrivate, "<ext/hash_map>", kPublic },
  { "<__locale>", kPrivate, "<locale>", kPublic },
  { "<__locale>", kPrivate, "<codecvt>", kPublic },
  { "<__locale>", kPrivate, "<fstream>", kPublic },
  { "<__locale>", kPrivate, "<regex>", kPublic },
  { "<__locale>", kPrivate, "<ios>", kPublic },
  { "<__mutex_base>", kPrivate, "<mutex>", kPublic },
  { "<__mutex_base>", kPrivate, "<condition_variable>", kPublic },
  { "<__mutex_base>", kPrivate, "<thread>", kPublic },
  { "<__split_buffer>", kPrivate, "<vector>", kPublic },
  { "<__split_buffer>", kPrivate, "<deque>", kPublic },
  { "<__tree>", kPrivate, "<map>", kPublic },
  { "<__tree>", kPrivate, "<set>", kPublic },
  { "<__tuple>", kPrivate, "<tuple>", kPublic },
  { "<__tuple>", kPrivate, "<array>", kPublic },
  { "<__tuple>", kPrivate, "<utility>", kPublic },
  { "<__tuple_03>", kPrivate, "<tuple>", kPublic },
  { "<__tuple_03>", kPrivate, "<array>", kPublic },
  { "<__tuple_03>", kPrivate, "<utility>", kPublic },
  // Private headers from dawrin /usr/include
  { "<__wctype.h>", kPrivate, "<_wctype.h>", kPrivate },
  { "<_ctype.h>", kPrivate, "<ctype.h>", kPublic },
  { "<_locale.h>", kPrivate, "<locale.h>", kPublic },
  { "<_locale.h>", kPrivate, "<xlocale.h>", kPublic },
  { "<_regex.h>", kPrivate, "<regex.h>", kPublic },
  { "<_regex.h>", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_regex.h
  { "<_stdio.h>", kPrivate, "<stdio.h>", kPublic },
  { "<_stdio.h>", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_stdio.h
  { "<_wctype.h>", kPrivate, "<wctype.h>", kPublic },
  { "<_wctype.h>", kPrivate, "<wchar.h>", kPublic },
  { "<_wctype.h>", kPrivate, "<xlocale.h>", kPublic }, // via xlocale/_wctype.h
  { "<_xlocale.h>", kPrivate, "<stdlib.h>", kPublic },
  { "<_xlocale.h>", kPrivate, "<xlocale.h>", kPublic },
  { "<sys/_select.h>", kPrivate, "<sys/select.h>", kPublic },
  { "<sys/_select.h>", kPrivate, "<sys/time.h>", kPublic },
  { "<sys/_types/_fd_def.h>", kPrivate, "<sys/select.h>", kPublic },
  { "<sys/_types/_fd_def.h>", kPrivate, "<sys/time.h>", kPublic },
  { "<sys/_types/_fd_def.h>", kPrivate, "<sys/types.h>", kPublic },
  { "<sys/_types/_iovec_t.h>", kPrivate, "<sys/socket.h>", kPublic },
  { "<sys/_types/_iovec_t.h>", kPrivate, "<sys/uio.h>", kPublic },
  { "<sys/_types/_ifmt.h>", kPrivate, "<sys/stat.h>", kPublic },
  { "<sys/_types/_ifmt.h>", kPrivate, "<sys/fcntl.h>", kPublic },
  { "<sys/_types/_s_ifmt.h>", kPrivate, "<sys/stat.h>", kPublic },
  { "<sys/_types/_s_ifmt.h>", kPrivate, "<sys/fcntl.h>", kPublic },
  { "<sys/_types/_seek_set.h>", kPrivate, "<sys/fcntl.h>", kPublic },
  { "<sys/_types/_seek_set.h>", kPrivate, "<sys/unistd.h>", kPublic },
  { "<sys/_types/_signaltstack.h>", kPrivate, "<sys/signal.h>", kPublic },
  { "<sys/_types/_signaltstack.h>", kPrivate, "<sys/uocontext.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<time.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<gethostuuid.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<sys/time.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<sys/aio.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<sys/select.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<sys/fcntl.h>", kPublic },
  { "<sys/_types/_timespec.h>", kPrivate, "<sys/stat.h>", kPublic },
  { "<sys/_types/_timeval.h>", kPrivate, "<sys/time.h>", kPublic },
  { "<sys/_types/_timeval.h>", kPrivate, "<sys/select.h>", kPublic },
  { "<sys/_types/_timeval.h>", kPrivate, "<sys/resource.h>", kPublic },
